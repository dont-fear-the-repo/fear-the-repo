...
class UserFormView extends React.Component {
  ...
  state = {  // kill this if props ever work
    canSubmit: false,
  ...
  render() {
    // const { canSubmit } = this.props;  // use this if props ever work
    return (
      <div className='container'>
        ...
        <div className='userinfo-form'>
          ...
          <RaisedButton label='Save'
                        disabled={!this.state.canSubmit}  // change to 'this.props.canSubmit' if props ever work
 ...
 * in the reducer, and changes being apparent in the devtools state. It seems to not
 * get pulled in by mapStateToProps, which makes it seem that connect is somehow not
 * tying the component to the store. Why?
*/
